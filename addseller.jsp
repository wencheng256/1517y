...
<%
	role ro=new role();
	Iterator<role> it1=ro.selectAll();
%>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <div class="tab">
      <div class="tab-body">
        ...
        <div class="tab-panel active" id="tab-set">
        	<form method="post" class="form-x" action="addseller">
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                    	<select name="role">
                    	<%while(it1.hasNext()){ role ro1=it1.next();%>	
                    		<option value="<%=ro1.getId()%>"><%=ro1.getName()%></option>
                    	<%} %>
                    	</select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                    	<input type="text" class="input" id="sitename" name="productinf" size="500" placeholder="商品简介" />
                    </div>
                </div>
