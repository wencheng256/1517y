	...
	<div class="line-big">
    	<div class="xm3">
        	<div class="panel border-back">
                ...
                <div class="panel-foot bg-back border-back">您好，<%=sellercon.getName() %></div>
            </div>
            <br />
        	<div class="panel">
        ...
        <div class="xm9">
            ...
            <div class="panel">
                ...
                <table class="table">
                    ...
                    <tr><td width="110" align="right">操作系统：</td><td>CentOS</td><td width="90" align="right">系统开发：</td><td><a href="#" target="_blank">拼图前端框架</a></td></tr>
                    <tr><td align="right">Web服务器：</td><td>Tomcat</td><td align="right">主页：</td><td><a href="#" target="_blank">#</a></td></tr>
                    <tr><td align="right">程序语言：</td><td>Java</td><td align="right">演示：</td><td><a href="#" target="_blank">http://demo.pintuer.com</a></td></tr>
